...
| Path | Purpose |
|------|---------|
| `/var/globe_history` | Holds range autogain, outline data, heatmap / replay data and traces if enabled.<br/>*Note: this data won't be automatically deleted, you will need to delete it eventually if you map this path.* |
