...
- [sdr-enthusiasts/docker-tar1090](#sdr-enthusiastsdocker-tar1090)
  ...
  - [Paths](#paths)
    ...
    - [Legacy AutoGain for RTLSDR Devices](#legacy-autogain-for-rtlsdr-devices)
...
| `READSB_FORWARD_MLAT`                 | If set to anything, it will include MLAT results in the Beast and SBS/BaseStation output. This may be desirable if you feed SBS data to applications like [VRS](https://github.com/sdr-enthusiasts/docker-virtualradarserver) or [PlaneFence](https://github.com/kx1t/docker-planefence) | `--forward-mlat`                        | Unset         |
